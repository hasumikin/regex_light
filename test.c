...
main(void)
{
  ...
  { /* ( ) */
    ...
    assert_match("a(bcd)ef", "Dabcdefhello", 2, "abcdef", "bcd");
    assert_match("a(bcd)ef", "aabcdefhello", 2, "abcdef", "bcd");
    ...
    assert_match("a([0-9]+)c", "aa123c", 2, "a123c", "123");
    assert_match("a(9)c", "a9c", 2, "a9c", "9");
    assert_match("a(9)c", "aa9c", 2, "a9c", "9");
